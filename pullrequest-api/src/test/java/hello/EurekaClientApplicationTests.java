...
import com.rafaelmd.pullrequest.main.EurekaClientApplication;
...
public class EurekaClientApplicationTests {
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/service-instances/pullrequest-api", String.class);

        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        then(response.getBody()).contains("pullrequest-api");
    }
